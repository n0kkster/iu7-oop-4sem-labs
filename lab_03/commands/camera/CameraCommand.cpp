...
MoveCameraCommand::MoveCameraCommand(const size_t cameraId, MoveParams &params) :
...
RotateCameraCommand::RotateCameraCommand(const size_t cameraId, RotationParams &params) :
